---
layout: project_post
title: "My Workflow Supercharged: How the Gemini CLI Revolutionized My Vibe Coding"
date: 2025-11-11
status: "IN_PROGRESS"
key_focus: "Workflow, Automation, CI/CD, Gemini"
---
...
It started with an idea and a conversation with the Gemini web chat. I'd get a block of code, copy it into VSCode, make some tiny changes, and then manually upload the files to my server. Every single change, no matter how small, required the same tedious process. It was a workflow that killed momentum and pushed creative ideas to "tomorrow."
...
Of course, sometimes things don't go according to plan. A build fails, an error pops up. But that's no longer a roadblock. I copy the error log, paste it to my Gemini agent, and ask, "What's happening here?" Most of the time, it's something silly that gets solved right there and then.
