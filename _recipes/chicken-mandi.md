...
layout: recipe
title: "Chicken Mandi"
description: "Traditional Yemeni Chicken Mandi using a large batch roasting tray method. Skin-on chicken legs roast on a wire rack above basmati rice, letting the rich savory fat drip down to perfectly coat and flavor the rice below. Finished with natural charcoal smoke."
prep_time: "30 mins"
cook_time: "1 hour 35 mins"
yields: "10 servings"
ingredients:
  ...
  - name: "Black Pepper"
    ...
    base_weight: 1.8
    weight_unit: "g"
  - name: "Kosher Salt (For entire dish)"
    base_volume: 0.6
    volume_unit: "tbsp"
    base_weight: 10.8
    weight_unit: "g"
  ...
  - name: "Ground Cloves"
    ...
    base_weight: 0.5
    weight_unit: "g"
  - name: "Chicken Full Legs (Skin-on)"
    base_volume: 1
    volume_unit: "lbs"
    base_weight: 450
    weight_unit: "g"
  - name: "Boiling Water"
    ...
    base_weight: 355
    weight_unit: "g"
  - name: "Basmati Rice (Soaked & Rinsed)"
    base_volume: 1
    volume_unit: "cups"
    base_weight: 190
    weight_unit: "g"
...
> [!IMPORTANT]
> **Important Note on Chicken Skin:** You should definitely use **skin-on** full legs. The traditional Mandi roasting tray setup relies heavily on the fat from the chicken skin rendering out and dripping through the wire rack into the rice below. This coats the rice in flavor and moisture. Skinless chicken will likely dry out in the high-heat oven, and the rice will lose its signature richness.
